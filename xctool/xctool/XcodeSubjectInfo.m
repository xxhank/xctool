...
static NSDictionary* BuildConfigurationsByActionForSchemePath(NSString *schemePath)
{
    ...
    return results;
} /* BuildConfigurationsByActionForSchemePath */
...
} /* findWorkspacePathForDerivedDataURL */
...
+ (NSArray*)workspacePathsForRelativeDerivedDataURL:(NSURL*)derivedDataWorkspaceURL
{
    ...
    return result;
} /* workspacePathsForRelativeDerivedDataURL */
                                             ...
                                             basePath:(NSString*)basePath
{
    ...
    for (NSXMLElement*node in commandLineArgumentNodes)
    {
        ...
        if (isEnabled)
        {
            ...
            {
                [combinedArgumentsString appendString_s:@" "];
            }
            [combinedArgumentsString appendString_s:argumentString];
        }
    }
...
} /* argumentsAndEnvironmentForTestAction */
...
} /* matchingSchemePathForWorkspace */
...
} /* populateBuildablesAndTestablesForWorkspaceWithSchemePath */
...
} /* populateBuildablesAndTestablesForProjectWithSchemePath */
...
} /* populateBuildActionPropertiesWithSchemePath */
